...
@section('title', 'Laporan Prioritas Pengadaan')
...
<div class="row mb-4 align-items-center no-print">
    <div class="col-md-6">
        <h2 class="fw-bold mb-1">Laporan Prioritas Pengadaan</h2>
...
<div class="card border-0 shadow-sm report-card">
    <div class="report-header text-center mb-5">
        ...
        <h3 class="fw-bold text-teal mb-1">LAPORAN PRIORITAS PENGADAAN</h3>
                ...
                <tr>
                    ...
                    <td class="small">
                        @if($material->status == 'Stock Out')
                            <strong class="text-danger">Segera Order! (Stok Habis)</strong>
                        @elseif($material->status == 'Reorder/Kritis')
                            <strong class="text-danger">Segera Order! (Di bawah Safety Stock)</strong>
                        @elseif($material->status == 'Warning')
                            <strong class="text-warning">Siapkan Order (Di bawah ROP)</strong>
                        @else
